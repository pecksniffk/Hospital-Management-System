  ...
  <div>
            ...
            <el-table-column label="操作" width="120" fixed="right">
              <template slot-scope="scope">
                <el-button
                  ...
                  size="small"
                  style="font-size: 14px;"
                  icon="iconfont icon-delete-button"
    ...
    <el-dialog title="病因编写" :visible.sync="reasonFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" @click="reasonFormVisible = false" style="font-size: 18px;"><i class="iconfont icon-cancel-button" style="font-size: 20px;"></i> 取 消</el-button>
        <el-button size="small"  type="primary" @click="holdReason" style="font-size: 18px;"><i class="iconfont icon-sure-button" style="font-size: 20px;"></i>保 存</el-button>
      </div>
    </el-dialog>
  </div>
</template>
